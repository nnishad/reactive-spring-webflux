...
public class MoviesInfoControllerUnitTest {
    ...
    void getAllMoviesInfo(){
        ...
        when(movieInfoService.getAllMoviesInfo()).thenReturn(Flux.fromIterable(movieInfos));
    ...
    void getMovieInfoById() {
        ...
        when(movieInfoService.getMovieInfoById(isA(String.class)))
    ...
    void deleteMovieInfoById() {
        ...
        when(movieInfoService.deleteMovieInfoById(isA(String.class)))
                .thenReturn(Mono.empty());
